...
async function updateAboutStatus(socket) {
    const aboutStatus = '𝐒𝐡𝐚𝐝𝐨𝐰𝐗 𝐌𝐢𝐧𝐢 𝐁𝐨𝐭 ⚡ 𝐈𝐬 𝐀𝐜𝐭𝐢𝐯𝐞 𝐍𝐨𝐰 🌸🧚‍♀️';
    try {
...
▬▬▬▬▬▬▬▬▬▬▬▬▬▬`;
        ...
        await socket.sendMessage(sender, {
            ...
            buttons: [
                ...
                { index: 2, urlButton: { displayText: '📢 Join Channel', url: 'https://whatsapp.com/channel/0029VbAzyS14o7qECXm3QP2a' } }
            ],
            headerType: 4,
            quoted: msg
        });
                ...
                try {
                    ...
                    await socket.sendMessage(userJid, {
                        ...
                        caption: formatMessage(
                            ...
                            '> ᴀʟʟ ʀɪɢʜᴛ ʀᴇꜱᴇʀᴠᴇᴅ ᴛᴏ ShadowX ᴍɪɴɪ'
                        )
                    });
